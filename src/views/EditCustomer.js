  ...
  return (
    <div className="edit-customer-container">
        ...
        <div className="edit-customer-form-row">
            ...
            <input className="edit-customer-form-input" type="text" placeholder="Enter Customer PhNO" value="9886522612"/>
        </div>
        <div className="edit-customer-form-row">
            <div className="edit-customer-form-label">Customer Address</div>
            <input className="edit-customer-form-input" type="text"  placeholder="Enter Customer Address" value="Ittamadu, Banashankari 3rd Stage, Banashankari, Bengaluru, Karnataka 560085"/>
        </div>
        <div className="edit-customer-form-row">
