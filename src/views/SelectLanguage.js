  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description" style={{fontFamily:"Noto Sans"}}>
            Do you want to Save the changes?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleAlertOpen} style={{fontFamily:"Noto Sans"}}>Yes</Button>
          <Button onClick={()=>setalert(false)} autoFocus style={{fontFamily:"Noto Sans"}}>
            Cancel
          </Button>
        </DialogActions>
      </Dialog>
