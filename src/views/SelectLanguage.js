  ...
  return (
    ...
    <img className="bg-img" src={require("../assets/BG.JPG")} />
      <div className="HomeHeader">
        <FaAngleLeft
          style={{ color: "white", height: "25px", marginLeft: "20px" }}
        />
      ...
      <div>
        ...
        <MdSignalCellularAlt  style={{position:'relative',left:'78%'}}/>
...
<BsBatteryFull style={{position:'relative',left:'82%'}}/>
          ...
          <div className="GreetingBox">
            ...
            <p className="GreetingsPara">Welcome to the family of 5000+ Cable & Internet Operators</p>
          </div>
        </div>
        <p className="SelectLangLabel">Select Your Language of Preference</p>
        ...
        <div className="BottomMessageContainer">
          ...
          <p className="BottomMessage">
            Language Option can be changed back at anytime, Some critical
            information will still continue to be in English.
          </p>
        </div>
